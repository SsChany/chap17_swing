...
public class StudentTableExample {
	...
	public StudentTableExample() {
		...
		List<Student> studentList = new ArrayList<>();
	       ...
	       //제목
	       String[] columnNames = {"Id", "Jumin", "Name", "Year", "Address", "Department"};
	       
	      //행의 갯수는 몇개가 될지 알수 없기 때문에 ArrayList의 사이즈를 갖고와서 배열 생성
	       ...
	       /*
	        * Swing에서 DefaultTableModel은 테이블의 데이터 구조를 정의하는 데
	        * 사용되는 TableModel 인터페이스의 기본 구현을 제공하는 클래스 입니다.
	        * 행과 열을 추가하거나 제거하고 개별 셀에서 값을 가져오고 설정하는 등 테이블의
	        * 데이터를 조작하는 메소드로 제공합니다.
	        */
	       DefaultTableModel model = new DefaultTableModel(data , columnNames);	//형식적인 코딩 //신경 안써도됨
	        ...
	        // 스크롤 패널이 프레임의 크기에 맞춰서 보여지도록 설정해줌
	        frame.pack();
