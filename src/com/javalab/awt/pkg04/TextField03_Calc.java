...
public class TextField03_Calc implements ActionListener {
	...
	JTextField tf1, tf2, tf3;	//두 칸은 입력칸, 마지막은 출력
	JButton b1, b2;	// + , - 버튼
	...
	public TextField03_Calc() {
		...
		tf3.setEditable(false);		//입력 불가 (결과만 보여줄거기 떄문에)
	...
	//액션 리스너
	public void actionPerformed(ActionEvent e) {	//ActionEvent이친구는 어떤 버튼이 눌렸는지 알고있다
		...
		if (e.getSource() == b1) {	//e.getSource() : 클릭된 자원이 누구인가?	
			c = a + b;
