 ...
 * 텍스트 필드(입력 필드)
 *  - JTextField : 입력 받는 칸
 *  - http://www.javatpoint.com/java-jtextfield
 */
public class TextField01 extends JFrame implements ActionListener {

	//필드
	// 윈도우 창 JFrame
	static JFrame frame;		//(main) static에서 접근하기위해 static으로 
	//텍스트 필드
    ...
    public static void main(String[] args) {
    	...
    	//버튼과 텍스트 필드를 추가할 패널 만들기		//JFrame 안에 panel 안에 button label등
    	...
    	//생성자 내부이면 그냥 add()해도 되는데 여기는 main()메소드 이므로
    	frame.add(panel);
    ...
    //actionPerformed는 ActionListener에 있는 추상 메소드 이름과 같아야 함. 바꿀수 없음.
