...
public class Label01 {
	...
	public static void main(String[] args) {
		...
		JLabel label1, label2; 	//레이블 변수 선언
		
		label1 = new JLabel("first label.");	 //레이블 객체 생성
		label1.setBounds(50, 50, 100, 30); //레이블 설정
		label1.setFont(label1.getFont().deriveFont(20.0f));
		
		label2 = new JLabel("Second label.");	 //레이블 객체 생성
		label2.setBounds(50, 100, 200, 30); //레이블 설정
